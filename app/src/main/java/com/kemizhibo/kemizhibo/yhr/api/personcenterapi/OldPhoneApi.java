...
public class OldPhoneApi extends BaseApi<SendYanZhengMaBean> {
    String token;
    String mobile;
    String code;
    public OldPhoneApi(HttpOnNextListener listener, RxAppCompatActivity rxAppCompatActivity, String token, String mobile,String code) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return httpGetService.getOldPhoneData(token,mobile,code);
    }
