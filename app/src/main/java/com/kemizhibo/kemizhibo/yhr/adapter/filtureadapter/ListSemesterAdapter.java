...
public class ListSemesterAdapter extends BaseAdapter {

    private Context context;
    private List<FilterBean.ContentBean.SemesterBean> list;
    ...
    public ListSemesterAdapter(Context context, List<FilterBean.ContentBean.SemesterBean> list) {
