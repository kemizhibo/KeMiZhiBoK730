...
public class ListMaterialAdapter extends BaseAdapter {

    private Context context;
    private List<FilterBean.ContentBean.MaterialBean> list;
    ...
    public ListMaterialAdapter(Context context, List<FilterBean.ContentBean.MaterialBean> list) {
