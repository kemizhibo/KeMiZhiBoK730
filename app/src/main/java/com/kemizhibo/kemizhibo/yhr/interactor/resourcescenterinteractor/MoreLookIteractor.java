 ...
 * Describe  第n次播放位置
 */
public class MoreLookIteractor {

    private IGetDataDelegate<OneLookBean> mDelegate;

    @Inject
    public MoreLookIteractor() {}

    /**
     * 执行网络操作，获取数据
     */
    public void loadMoreLookData(BaseActivity activity, IGetDataDelegate<OneLookBean> mDelegate, String token, String playPosition,String keyId, String courseId, String watchTime, String isEnd){
