...
public class YingXiangFragmentIteractor {
     ...
     * 执行网络操作，获取数据
     */
    public void loadYingXiangFragmentData(BaseActivity activity, IGetDataDelegate<YingXiangFragmentBean> mDelegate,String token,String sellType,String currentPage,String pageSize,String materialEdition,String subjectId,String semester,String knowledgeId){
        this.mDelegate = mDelegate;
        YingXiangFragmentApi yingXiangFragmentApi = new YingXiangFragmentApi(listener,activity,token,sellType,currentPage,pageSize,materialEdition,subjectId,semester,knowledgeId);
