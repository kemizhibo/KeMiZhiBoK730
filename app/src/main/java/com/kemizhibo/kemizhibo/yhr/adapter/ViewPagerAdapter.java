...
public class ViewPagerAdapter extends PagerAdapter{
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        Glide.with(mContext).load(mData.get(position).getImgList().get(position).toString()).error(R.mipmap.milier).placeholder(R.mipmap.milier).into(pictrue_details_viewpager);
