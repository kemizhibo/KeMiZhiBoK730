...
public class ViewPagerAdapter extends PagerAdapter{
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        SimpleDraweeView pictrue_details_viewpager = (SimpleDraweeView) view.findViewById(R.id.pictrue_details_viewpager);
        ...
        for (int i = 0;i<mData.get(position).getImgList().size();i++){
            ...
            SimpleDraweeView simpleDraweeView = pictrue_details_viewpager;
