    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.finish_butn:
                personSchoolNameEdittextHint = personSchoolNameEdittext.getHint().toString();
                personLianxirenEdittextHint = personLianxirenEdittext.getHint().toString();
                personTypeEdittextHint = personTypeEdittext.getHint().toString();
                personGradleEdittextHint = personGradleEdittext.getHint().toString();
                personAddressEdittextHint = personAddressEdittext.getHint().toString();
                personIdcardEdittextHint = personIdcardEdittext.getHint().toString();
                personEmailEdittextHint = personEmailEdittext.getHint().toString();
                sp = getSharedPreferences("logintoken", 0);
                token = sp.getString("token", "");
